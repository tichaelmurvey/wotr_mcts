...
STARTING_POSITIONS: Tuple[StartingPosition, ...] = (
    # Dwarves
    StartingPosition(
        R.EREBOR, Counter({AU.dwar_reg: 1, AU.dwar_elt: 2, AU.dwar_ldr: 1})
    ),
    ...
    # Gondor
    StartingPosition(
        R.MINAS_TIRITH, Counter({AU.gond_reg: 3, AU.gond_elt: 1, AU.gond_ldr: 1})
    ),
...
REINFORCEMENTS_SHADOW: GenericUnitGroupWithNazgul = Counter(
    {
        AU.isen_reg: 6,
        AU.isen_elt: 5,
        AU.mord_reg: 8,
