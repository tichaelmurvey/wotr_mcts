...
STARTING_POSITIONS: Tuple[StartingPosition, ...] = (
    # Dwarves
    StartingPosition(R.EREBOR, Counter({AU.dwar_reg: 1, AU.dwar_elt: 2, AU.dwar_ldr: 1})),
    StartingPosition(R.ERED_LUIN, Counter({AU.dwar_reg: 1})),
    StartingPosition(R.IRON_HILLS, Counter({AU.dwar_reg: 1})),
    # Elves
    StartingPosition(R.GREY_HAVENS, Counter({AU.elvn_reg: 1, AU.elvn_elt: 1, AU.elvn_ldr: 1})),
    StartingPosition(R.RIVENDELL, Counter({AU.elvn_elt: 2, AU.elvn_ldr: 1})),
    StartingPosition(R.WOODLAND_REALM, Counter({AU.elvn_reg: 1, AU.elvn_elt: 1, AU.elvn_ldr: 1})),
    StartingPosition(R.LORIEN, Counter({AU.elvn_reg: 1, AU.elvn_elt: 2, AU.elvn_ldr: 1})),
    # Gondor
    StartingPosition(R.MINAS_TIRITH, Counter({AU.gond_reg: 3, AU.gond_elt: 1, AU.gond_ldr: 1})),
    ...
    # Sauron
    StartingPosition(R.BARAD_DUR, Counter({AU.mord_reg: 4, AU.mord_elt: 1, AU.nazgul: 1})),
    StartingPosition(R.DOL_GULDUR, Counter({AU.mord_reg: 5, AU.mord_elt: 1, AU.nazgul: 1})),
...
REINFORCEMENTS_FREE: GenericUnitGroup = Counter({
    AU.dwar_reg: 2,
    AU.dwar_elt: 3,
    AU.dwar_ldr: 3,
    AU.elvn_reg: 2,
...
REINFORCEMENTS_SHADOW: GenericUnitGroup = Counter({
    AU.isen_reg: 6,
    AU.isen_elt: 5,
    AU.mord_reg: 8,
    AU.mord_elt: 4,
